...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Departement d2 = new Departement(2, "Eletronics");
            Departement d3 = new Departement(3, "Fashion");
            Departement d4 = new Departement(4, "Books");
            ...
            _context.Departement.AddRange(d1, d2, d3, d4);
